...
/obj/mecha/combat/phazon/vertibird/ncr
	...
	desc = "A real useable, and working vertibird, maintained with luck, sweat, and ducktape. This one seems to be more focused toward troop transport, and is painted in the colors of the NCR."
...
/obj/mecha/combat/phazon/ncrtruck
	...
	desc = "A truck running on power cells. Nice eh? Still a wreck."
...
/obj/mecha/combat/phazon/ncrtruck/mp
	...
	desc = "A truck running on power cells. Nice eh ? still a wreck. This truck has been given to the NCR MPs, and has been modified to go a bit faster. But has less seats and is a bit less solid."
...
/obj/mecha/combat/phazon/buggy
	name = "\improper Buggy"
	desc = "A light vehicle, not very powerful or solid, running on a power cell."
...
/obj/mecha/combat/phazon/buggy/ranger
	...
	desc = "A light vehicle, not very powerful or solid, running on a power cell. This one has been recolored by the Rangers."
...
/obj/mecha/combat/phazon/buggy/rangerarmed
	...
	desc = "A light vehicle, not very powerful or solid, running on a power cell. This one has been recolored by the Rangers... And Ranger Rico ''Gunner'' Davberger is gonna shoot with his shotgun."
...
/obj/mecha/combat/phazon/buggy/legion
	...
	desc = "A light vehicle, not very powerful or solid, running on a power cell... Okay, that's a lie. It's actually run on power generated by the horse...The cell is here to make sure that some component of the buggy half works."
...
/obj/mecha/combat/phazon/buggy/legionarmed
	...
	desc = "A light vehicle, not very powerful or solid, running on a power cell... Okay, that's a lie. It's actually run on power generated by the horse...The cell is here to make sure that some component of the buggy half works. This one has been recolored by the Legion... And Prime Decanus Messala ''Gunner'' Davius is gonna shoot with his shotgun."
...
/obj/mecha/combat/phazon/highwayman
	...
	desc = "A fast vehicle, running on a power cell. YUP! ITS THE HIGHWAYMAN! Kinda. Its not the original, but a budget version."
...
/obj/mecha/combat/phazon/corvega
	...
	desc = "An old vehicle, running on a power cell."
...
/obj/mecha/combat/phazon/corvega/police
	...
	desc = "An old vehicle, running on a power cell. Seems to have been the proprety of the pre-war Yuma PD."
...
/obj/mecha/combat/phazon/pickuptruck/blue
	name = "\improper pickup truck"
	desc = "An old vehicle, running on a powercell."
...
/obj/mecha/combat/phazon/pickuptruck/bos/armed
	...
	desc = "An old vehicle, running on a power cell. Its a a modified Brotherhood truck, with the addition of a laser rifle at the back, manned by Paladin Kiana Davberg. Consumes more and is a more fragile."
...
/obj/mecha/combat/phazon/truckcaravan
	...
	desc = "A vehicle, not very powerful or solid, running on a power cell... Okay, that's a lie. Its pulled by two brahmins...The cell is here to make sure that some component of the buggy-half works."
